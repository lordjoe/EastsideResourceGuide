...
public class Encrypt {
    ...
    static {
        int cypherLength = 2 * DEFAULT_KEY_ENCRYPTED.length();
        INTERNAL_ENCRYPTOR.setCypherLength(cypherLength);
        ...
        DEFAULT_KEYX = INTERNAL_ENCRYPTOR.decrypt(DEFAULT_KEY_ENCRYPTED).trim();
    }
