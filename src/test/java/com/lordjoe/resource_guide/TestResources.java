...
public class TestResources {
    ...
    public static CommunityResource ASIAN = new CommunityResource(AsianId,ASIAN_NAME, ResourceType.Resource,Section1Id);
    public static CommunityResource DUVALL = new CommunityResource(DuvallID,"Duvall City Hall", ResourceType.Resource,AsianId);
    public static CommunityResource WOODINVILLE = new CommunityResource(WoodinvilleId,"Woodinville City Hall", ResourceType.Resource,AsianId);
    public static CommunityResource YARROW = new CommunityResource(YarrowPointID,"Yarrow Point Town Hall", ResourceType.Resource,AsianId);
    public static CommunityResource BELLEVUE = new CommunityResource(BellvueID,"Bellevue Mini City Hall – Crossroads Shopping Center", ResourceType.Resource,Section1Id);
    public static CommunityResource Chinese  = new CommunityResource(ChineseID,"Chinese Information & Service Center (CISC)", ResourceType.Resource,Section2Id);
    public static CommunityResource NorthBellevue  = new CommunityResource(NorthBellevueID,"North Bellevue Community Center", ResourceType.Resource,Section2Id);
    public static CommunityResource Isaquah = new CommunityResource(IsaquahID,"Issaquah Library", ResourceType.Resource,Section1Id);
    public static CommunityResource RedPost = new CommunityResource(RedPostID,"Redmond Post 161", ResourceType.Resource,IsaquahID);
    public static CommunityResource BothelPost = new CommunityResource(BothelPostID,"Bothell Post 127", ResourceType.Resource,IsaquahID);
